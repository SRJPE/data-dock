...
-   Publishing data publicly through the Environmental Data Initiative (EDI)

-   Visualizing and exploring data using open-source tools

-   Providing a replicable workflow for data publication and access
...
-   Samples collected for physical parameters (temperature, pH) and laboratory analysis (nitrogen, phosphorus)
...
All data is stored internally and published to the [Environmental Data Initiative (EDI)](https://edirepository.org/), NSF-funded public repository for open access.

-   Dashboard pulls data directly from EDI for visualization

-   Built in **R Shiny** : all code available on [GitHub](https://github.com/SRJPE/data-dock)

-   EDI publication in progress; dashboard will be updated when available
...
The dashboard has two main tabs, each with a **Download** sub-tab for exporting data:

| Tab               | What you can do                                                              |
|-------------------|------------------------------------------------------------------------------|
| **Water Quality** | Visualize temporal trends, explore analyte patterns, select sites on the map |
| **Genetics**      | Explore run assignment distributions across locations and years              |
