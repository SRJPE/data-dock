...
```{r echo=FALSE}
line_plot_year <- ggplot(run_summary_complete_2 |> filter(location_name == "Battle"), aes(x = date, y = run_percent, color = field_run_type_id, group = field_run_type_id)) +
  geom_line() +
  geom_point() +
  scale_color_manual(values = tol_muted) +
  scale_y_continuous(limits = c(0, 100),
...
```{r echo=FALSE}
line_plot_year_2 <- ggplot(run_summary_complete_2 |> filter(location_name == "Mill"), aes(x = date, y = run_percent, color = field_run_type_id, group = field_run_type_id)) +
  geom_line() +
  geom_point() +
  scale_color_manual(values = tol_muted) +
  scale_y_continuous(limits = c(0, 100),
